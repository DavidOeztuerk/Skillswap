...
public class SuspiciousActivityDetectedEventConsumer : IConsumer<SuspiciousActivityDetectedEvent>
{
    private readonly IMediator _mediator;
    private readonly ILogger<SuspiciousActivityDetectedEventConsumer> _logger;

    public SuspiciousActivityDetectedEventConsumer(
        IMediator mediator,
