        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DigestNotificationId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PushReminders = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationDigestEntries_CreatedAt",
                table: "NotificationDigestEntries",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationDigestEntries_IsProcessed",
                table: "NotificationDigestEntries",
                column: "IsProcessed");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationDigestEntries_UserId",
                table: "NotificationDigestEntries",
                column: "UserId");
