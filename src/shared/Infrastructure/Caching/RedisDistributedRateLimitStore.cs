...
//             var resultArray = result as RedisResult[];
...
//             var isAllowed = (long)(RedisValue)resultArray[0] == 1;
//             var currentCount = (long)(RedisValue)resultArray[1];
//             var limitValue = (long)(RedisValue)resultArray[2];

//             TimeSpan? resetTime = null;
//             if (resultArray.Length > 3 && ((RedisValue)resultArray[3]).HasValue)
//             {
//                 var ttlSeconds = (long)(RedisValue)resultArray[3];
