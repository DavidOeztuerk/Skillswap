...
export const getBasicWebRTCBrowserCapabilities = (): {
  ...
  // Get RTCPeerConnection constructor with browser prefix fallbacks
  const getRTCPeerConnection = (): typeof RTCPeerConnection | undefined => {
    if (typeof window.RTCPeerConnection !== 'undefined') {
      return window.RTCPeerConnection;
    }
    if (typeof legacyWindow.webkitRTCPeerConnection !== 'undefined') {
      return legacyWindow.webkitRTCPeerConnection;
    }
    if (typeof legacyWindow.mozRTCPeerConnection !== 'undefined') {
      return legacyWindow.mozRTCPeerConnection;
    }
    return undefined;
  };
