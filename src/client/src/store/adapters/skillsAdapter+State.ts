...
import type { ProficiencyLevel, Skill, SkillCategory } from '../../types/models/Skill';
...
export const mapSkillResponseToSkill = (response: SkillSearchResultResponse): Skill => ({
  ...
  lastActiveAt: response.lastActiveAt != null ? response.lastActiveAt.toString() : undefined,
});
