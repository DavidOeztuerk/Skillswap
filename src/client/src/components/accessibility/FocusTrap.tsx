import React, { useEffect, useRef, useCallback, type ReactNode, memo } from 'react';
 ...
 */
const FocusTrap: React.FC<FocusTrapProps> = memo(
  ({ children, active, onEscape, restoreFocus = true, initialFocusRef }) => {
    ...
    }, [active, restoreFocus, initialFocusRef, getFocusableElements, handleKeyDown]);
