...
export const ERROR_MESSAGES = {
  ...
  PERMISSION_DENIED: 'Access denied. You do not have permission for this action.',
...
/**
 * Weekdays (English values for API, used internally)
 */
...
/**
 * Weekday labels for display (German)
 * Maps English day names to German display labels
 */
...
/**
 * Helper function to get German label for a weekday
 */
export const getWeekdayLabel = (day: string): string => WEEKDAY_LABELS[day] || day;
