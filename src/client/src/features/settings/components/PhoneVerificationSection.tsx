...
import { getProfile } from '../../auth/store/authThunks';
...
const PhoneVerificationSection: React.FC<PhoneVerificationSectionProps> = memo(
  ({ currentPhone, isVerified = false, onVerificationComplete }) => {
    ...
    // Handle phone removal - show confirm dialog
    const handleRemovePhone = (): void => {
      setShowRemoveConfirm(true);
    };

    // Execute phone removal after confirmation
    const executeRemovePhone = async (): Promise<void> => {
    ...
    return (
      <>
        ...
        <ConfirmDialog
          ...
          message="Möchten Sie Ihre Telefonnummer wirklich entfernen?"
          confirmLabel="Entfernen"
          cancelLabel="Abbrechen"
          onConfirm={() => {
            void executeRemovePhone();
          }}
