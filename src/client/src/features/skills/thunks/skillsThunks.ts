  ...
  async (skillId, { rejectWithValue }) => {
    try {
      ...
      const skill: Skill = {
        ...
        createdAt: String(skillData.createdAt),
        lastActiveAt: String(skillData.updatedAt),
      };
...
>(
  ...
  (
    _: { name: string; level: string; rank: number; color?: string; description?: string },
    { rejectWithValue }
  ) => {
    ...
    return rejectWithValue({
      success: false,
      errors: ['Create proficiency level endpoint not implemented'],
      message: 'Create proficiency level endpoint not implemented',
    });
  }
);
...
export const updateProficiencyLevel = createAppAsyncThunk<
  undefined,
  { id: string; updates: { name?: string; description?: string; rank?: number } }
>(
  'skills/updateProficiencyLevel',
  (
    _: { id: string; updates: { name?: string; description?: string; rank?: number } },
    { rejectWithValue }
  ) => {
    // This endpoint doesn't exist in backend
    ...
    return rejectWithValue({
      success: false,
      errors: ['Update proficiency level endpoint not implemented'],
      message: 'Update proficiency level endpoint not implemented',
    });
  }
);
...
export const deleteProficiencyLevel = createAppAsyncThunk<string, string>(
  ...
  (_: string, { rejectWithValue }) => {
    // This endpoint doesn't exist in backend
    console.warn('deleteProficiencyLevel: Backend endpoint not implemented');
    return rejectWithValue({
      success: false,
      errors: ['Delete proficiency level endpoint not implemented'],
      message: 'Delete proficiency level endpoint not implemented',
    });
  }
);
...
>(
  ...
  (
    _: { name: string; iconName?: string; color?: string; description?: string },
    { rejectWithValue }
  ) => {
    // This endpoint doesn't exist in backend
    ...
    return rejectWithValue({
      success: false,
      errors: ['Create category endpoint not implemented'],
      message: 'Create category endpoint not implemented',
    });
  }
);
...
export const updateCategory = createAppAsyncThunk<
  ...
  {
    id: string;
    updates: { name?: string; iconName?: string; color?: string; description?: string };
  }
>(
  ...
  (
    ...
    return rejectWithValue({
      success: false,
      errors: ['Update category endpoint not implemented'],
      message: 'Update category endpoint not implemented',
    });
  }
);
...
export const deleteCategory = createAppAsyncThunk<string, string>(
  ...
  (_: string, { rejectWithValue }) => {
    ...
    return rejectWithValue({
      success: false,
      errors: ['Delete category endpoint not implemented'],
      message: 'Delete category endpoint not implemented',
    });
  }
);
