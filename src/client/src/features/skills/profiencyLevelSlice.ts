    ...
    try {
      ...
      return rejectWithValue(
        error instanceof Error
          ? error.message
          : 'Kompetenzlevel konnten nicht geladen werden'
      );
    }
  }
);
  ...
  async (
    ...
    try {
      ...
      return rejectWithValue(
        error instanceof Error
          ? error.message
          : 'Kompetenzlevel konnte nicht erstellt werden'
      );
    }
  }
);
  ...
  async (
    ...
    try {
      ...
      return rejectWithValue(
        error instanceof Error
          ? error.message
          : 'Kompetenzlevel konnte nicht aktualisiert werden'
      );
    }
  }
);
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error
          ? error.message
          : 'Kompetenzlevel konnte nicht gelöscht werden'
      );
    }
  }
);
