...
import type { AdminAppointmentFilters, AdminMatchFilters } from './adminAdapter+State';
import type {
...
export const fetchAdminAppointments = createAppAsyncThunk<
  ...
  { page?: number; limit?: number; filters?: AdminAppointmentFilters }
...
export const fetchAdminMatches = createAppAsyncThunk<
  ...
  { page?: number; limit?: number; filters?: AdminMatchFilters }
