...
import { selectCategories } from '../../skills/store/categoriesSelectors';
import {
  fetchCategories,
  updateCategory,
  createCategory,
  deleteCategory,
} from '../../skills/store/thunks/categoryThunks';
import type { SkillCategory } from '../../skills/types/Skill';
...
const SkillCategoriesManagement: React.FC = () => {
  ...
  useEffect(() => {
    ...
    initialize().catch(() => {});
  }, [canManageCategories, navigate, dispatch, loadCategories]);
