...
export const useAdmin = (): {
  ...
  setAppointmentFilters: (filters: AdminAppointmentFilters) => void;
  setMatchFilters: (filters: AdminMatchFilters) => void;
  ...
  const actions = useMemo(
    () => ({
      ...
      setAppointmentFilters: (filters: AdminAppointmentFilters) => {
        dispatch(setAppointmentFilters(filters));
      },

      setMatchFilters: (filters: AdminMatchFilters) => {
