...
import type { SecurityAlertStatisticsResponse } from '../../notifications/types/SecurityAlert';
...
/** Get chip color based on alert count thresholds */
function getAlertCountColor(count: number): 'error' | 'warning' | 'default' {
              ...
              {statistics.alertsByType
                ...
                .map((item, index) => (
                  ...
                  >
                    ...
                    <Chip label={item.count} size="small" color={getAlertCountColor(item.count)} />
                  </Box>
                ))}
            </Box>
                ...
                {statistics.topAffectedUsers.slice(0, 10).map((user, index) => (
                  ...
                  >
                    ...
                    <Chip
                      ...
                      size="small"
                      color={getAlertCountColor(user.alertCount)}
                    />
                  </Box>
                ))}
              </Box>
                ...
                {statistics.topAffectedIPs.slice(0, 10).map((ip, index) => (
                  ...
                  >
                    ...
                    <Chip
                      label={ip.alertCount}
                      size="small"
                      color={getAlertCountColor(ip.alertCount)}
                    />
                  </Box>
                ))}
              </Box>
