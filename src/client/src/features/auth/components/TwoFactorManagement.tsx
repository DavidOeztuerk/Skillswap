        ...
        <CardContent>
          ...
          <Box mt={3}>
            ...
            <Typography variant="body2" color="textSecondary" component="p" sx={{ mb: 2 }}>
              When two-factor authentication is enabled, you&apos;ll be prompted for a verification
              code from your authenticator app whenever you sign in. This ensures that only you can
