...
import type { NotificationsEntityState } from './notificationsAdapter+State';
...
export const selectNotificationChannelEnabled = createSelector(
  ...
  (settings, preferences) => ({
    email: settings.emailEnabled && preferences.emailNotifications,
    push: settings.pushEnabled && preferences.pushNotifications,
