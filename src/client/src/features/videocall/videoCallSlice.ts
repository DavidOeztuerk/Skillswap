  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getCallConfig.rejected, (state, action) => {
        state.isLoading = false;
        state.errorMessage = action.payload?.message ?? 'Failed to get call config';
      })
      ...
      .addCase(joinVideoCall.rejected, (state, action) => {
        state.isInitializing = false;
        state.errorMessage = action.payload?.message ?? 'Failed to join call';
      })
      ...
      .addCase(saveCallInfo.rejected, (state, action) => {
        ...
        console.warn('Save call info failed:', action.payload?.message);
      })
      ...
      .addCase(startRecording.rejected, (state, action) => {
        state.isLoading = false;
        state.errorMessage = action.payload?.message ?? 'Failed to start recording';
      })
      ...
      .addCase(stopRecording.rejected, (state, action) => {
        ...
        state.isRecording = false;
        console.warn('Stop recording failed:', action.payload?.message);
      })
