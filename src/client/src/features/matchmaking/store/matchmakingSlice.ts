...
import { initialMatchesState, matchesAdapter } from './matchmakingAdapter+State';
import {
  createMatchRequest,
  fetchMatches,
  fetchUserMatches,
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createMatchRequest.rejected, (state, action) => {
        state.isLoading = false;
        state.errorMessage =
          action.payload?.message ?? action.error.message ?? 'Failed to create match request';
      })
      ...
      .addCase(fetchUserMatches.rejected, (state, action) => {
        state.isLoadingMatches = false;
        state.errorMessage =
          action.payload?.message ?? action.error.message ?? 'Failed to fetch user matches';
      })
      ...
      .addCase(fetchIncomingMatchRequests.rejected, (state, action) => {
        ...
        state.errorMessage =
          ...
          'Failed to fetch incoming match requests';
      })
      ...
      .addCase(fetchOutgoingMatchRequests.rejected, (state, action) => {
        ...
        state.errorMessage =
          action.payload?.message ??
          action.error.message ??
          'Failed to fetch outgoing match requests';
      })
      ...
      .addCase(acceptMatchRequest.rejected, (state, action) => {
        state.isLoading = false;
        state.errorMessage =
          action.payload?.message ?? action.error.message ?? 'Failed to accept match request';
      })
      ...
      .addCase(rejectMatchRequest.rejected, (state, action) => {
        state.isLoading = false;
        state.errorMessage =
          action.payload?.message ?? action.error.message ?? 'Failed to reject match request';
      })
      ...
      .addCase(fetchMatchRequestThread.rejected, (state, action) => {
        state.isLoadingThread = false;
        state.errorMessage =
          action.payload?.message ?? action.error.message ?? 'Failed to fetch match request thread';
      });
  },
});
