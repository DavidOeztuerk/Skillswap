...
import { WEEKDAYS, TIME_SLOTS } from '../../../core/config/constants';
import { useAppDispatch, useAppSelector } from '../../../core/store/store.hooks';
import PageContainer from '../../../shared/components/layout/PageContainer';
import PageHeader from '../../../shared/components/layout/PageHeader';
import LoadingSpinner from '../../../shared/components/ui/LoadingSpinner';
import { selectAuthUser } from '../../auth/store/authSelectors';
import { selectUserSkills } from '../../skills/store/skillsSelectors';
import {
...
import type { MatchRequestInThreadDisplay } from '../types/MatchmakingDisplay';
...
const MatchRequestTimelinePage: React.FC = () => {
  ...
  const handleSendCounterOffer = (): void => {
    ...
    const latestRequest = currentThread.requests.at(-1);
    ...
    const counterOfferRequest = {
      ...
      offeredAmount: offerType === 'monetary' ? Number.parseFloat(offeredAmount) : undefined,
      currency: 'EUR',
