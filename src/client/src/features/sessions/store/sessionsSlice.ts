    ...
    builder
      ...
      .addCase(startSession.rejected, (state, action) => {
        ...
        state.error = {
          ...
          message: errorPayload?.message ?? action.error.message ?? 'Failed to start session',
      ...
      .addCase(completeSession.rejected, (state, action) => {
        ...
        state.error = {
          code: errorPayload?.code,
          message: errorPayload?.message ?? action.error.message ?? 'Failed to complete session',
          details: errorPayload?.details,
        };
      })
      ...
      .addCase(rateSession.rejected, (state, action) => {
        ...
        state.error = {
          code: errorPayload?.code,
          message: errorPayload?.message ?? action.error.message ?? 'Failed to rate session',
          details: errorPayload?.details,
        };
      })
      ...
      .addCase(rescheduleSession.rejected, (state, action) => {
        ...
        state.error = {
          code: errorPayload?.code,
          message: errorPayload?.message ?? action.error.message ?? 'Failed to reschedule session',
          details: errorPayload?.details,
        };
      })
      ...
      .addCase(cancelSession.rejected, (state, action) => {
        ...
        state.error = {
          code: errorPayload?.code,
          message: errorPayload?.message ?? action.error.message ?? 'Failed to cancel session',
          details: errorPayload?.details,
        };
      })
      ...
      .addCase(processSessionPayment.rejected, (state, action) => {
        ...
        state.error = {
          code: errorPayload?.code,
          message: errorPayload?.message ?? action.error.message ?? 'Failed to process payment',
          details: errorPayload?.details,
        };
      });
  },
