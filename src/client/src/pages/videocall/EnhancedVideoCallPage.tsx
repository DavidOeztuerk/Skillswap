...
//   // Attach MediaStream objects to the video elements when they change
//   useEffect(() => {
//     try {
...
//         if (remoteStream) {
//           // attempt to play (may require user gesture); log errors
//           remoteVideoRef.current.play().catch((e) => console.warn('Remote video play failed', e));
//         }
//       }
//     } catch (err) {
//       console.warn('Error attaching remote stream to element', err);
//     }
//   }, [remoteStream]);
...
//       }
//     } catch (err) {
//       console.warn('Error attaching local stream to element', err);
//     }
//   }, [localStream]);
